...
export function AccountNotExist({ displayState, closeState }) {
  return (
    <div className={displayState}>
      <div className="alert-modal-container">
        <div className="alert-modal-content">
...
export function PasswordNotMatch({ displayState, closeState }) {
  return (
    <div className={displayState}>
      <div className="alert-modal-container">
        <div className="alert-modal-content">
      ...
      <div className="alert-modal-container">
        <div className="alert-modal-content">
          ...
          <div className="modal-message">
            ...
            <span className="boldAlert">OOPS!</span>
             Sorry, please select the Parent Account Number.
          </div>
        </div>
      </div>
    </div>
...
export function UnamePassIncorrect({ displayState, closeState }) {
  return (
    <div className={displayState}>
      <div className="alert-modal-container">
        <div className="alert-modal-content">
          ...
          <div className="modal-message">
            ...
            <span className="boldAlert">OOPS!</span>
             Sorry, the username/password is invalid/incorrect.
          </div>
        </div>
      </div>
    </div>
...
export function SignUpSuccessful({ displayState, closeState }) {
  return (
    <div className={displayState}>
      <div className="alert-modal-container">
        <div className="alert-modal-content">
          ...
          <div className="modal-message">
            ...
            <span className="boldAlert">GREAT!</span>
             Successful sign up! You can now proceed to log in.
          </div>
        </div>
      </div>
    </div>
